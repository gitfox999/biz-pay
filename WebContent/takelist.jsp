...
<%
	...
	PreparedStatement preparedStatement = connection.prepareStatement("select count(*) _count from takeorder where memid="+id
			+" and ts >= '"+S_date+"' and ts <= '"+E_date+" 23:59:59'");
	ResultSet resultSet = preparedStatement.executeQuery();
	resultSet.next();
	int allCount = resultSet.getInt("_count");
	int pageCount = allCount/size+1;
	preparedStatement = connection.prepareStatement("select * from takeorder where memid="+id
			+" and ts >= '"+S_date+"' and ts <= '"+E_date+" 23:59:59' order by ts desc limit "+(pageno - 1)*size+","+pageno*size);
	resultSet = preparedStatement.executeQuery();
	String lastPage = "takelist.jsp?page="+pageCount;
	String nextPage = "takelist.jsp?page="+(pageno+1);
	String prePage = "takelist.jsp?page="+(pageno-1);
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tbody><tr>
    <form id="MyForm" action="takelist.jsp" method="get"></form>
    ...
    <tr style="background-color: rgb(255, 255, 255);">
      ...
      while(resultSet.next()){
    	  ...
    	  int istate = resultSet.getInt("state");
	  ...
	  %>
	  	<th colspan="5"><div class="Pagination"><a href="takelist.jsp?page=1" class="tips" title="首页">首页</a> 
