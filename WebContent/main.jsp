            ...
            <div class="news-bg" style="margin: -4px auto;width: 1028px;height: 33px;background: url(&#39;resource/images/newsbg.png&#39;) no-repeat 0 center;">
                <div class="news-wrap">
                    <div class="news-item floatL">
                                                                        <marquee id="ele-msgNews" behavior="scroll" scrollamount="1" direction="left" style="height:100%;  width: 750px;margin: 2px -10px;"></marquee>
...
<div class="ssc_left">
    <iframe id="mainframe" name="mainframe" frameborder="0" scrolling="no" width="810" src="ssc.jsp" height="940" style="background:transparent;"></iframe>
...
﻿<div class="footer">
        ...
        <a href="javascript:AboutUs(8);">合作伙伴</a>
            ...
            <a class="footer-service floatL" href="http://www.js9588.com/Lottery/Csc.php###" onclick="OnlineServer();"></a>
        </div>
            </div>
    <div class="footer-bottom-bg">
        <div class="footer-bottom">
            <div class="footer-img">
                <a href="http://www.js9588.com/Lottery/Csc.php#" id="bblogo" class="floatL"></a>
